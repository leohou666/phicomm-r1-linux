...
its="$project_root/scripts/r1-linux-mainline-6.18-ak7755-bluealsa-a25r3.its"
fit="$artifacts/r1-linux-mainline-6.18-ak7755-bluealsa-a25r3.itb"
...
echo "A25r3 endpoint-first BlueALSA FIT verified; eMMC was not modified."
